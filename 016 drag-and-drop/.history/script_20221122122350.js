...
function showInputBox(column) {
  ...
  saveItemBtns[column].getElementsByClassName.display = "flex";
...
function hideInputBox(column) {
  ...
  saveItemBtns[column].getElementsByClassName.display = "none";
  addItemContainers[column].style.display = "nonex";
}
